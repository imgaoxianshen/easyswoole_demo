...
require_once dirname(__DIR__) . '/extends/dypls/api_sdk/vendor/autoload.php';
...
// use Dyplsapi\Request\V20170525\BindAxnRequest;
...
class Dypls
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIKXL5fg5n6RAv"; // AccessKeyId

        $accessKeySecret = "LI3o6mNl00SQozXo5AHUVymJyM3vtL"; // AccessKeySecret
     ...
     * @throws ClientException
     */
    public static function bindAxn($phoneA) {
        ...
        //必填:号池Key
        $request->setPoolKey("FC100000062166422");
        ...
        //可选:期望分配X号码归属的地市(省去地市后缀后的城市名称)
        $request->setExpectCity("温州");

        //必填:95中间号,NO_170代表选择使用170号码资源
        $request->setNoType("NO_95");

        //必填:绑定关系对应的失效时间-不能早于当前系统时间
        $request->setExpiration(date('Y-m-d H:i:s',time()+31536000));
