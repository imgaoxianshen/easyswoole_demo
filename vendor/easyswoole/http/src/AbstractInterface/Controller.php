...
abstract class Controller
{
    ...
    protected function validate(Validate $validate)
    {
        ...
        // var_dump($this->request()->getHeaders('token'));
        // var_dump(array_merge($this->request()->getRequestParam(),['token' => $this->request()->getHeaders('token')]));
        // return $validate->validate($this->request()->getRequestParam());
        return $validate->validate(array_merge($this->request()->getRequestParam(),['token' => $this->request()->getHeaders('token')]));
    }
